...
{{--                </div>--}}
                ...
                @if($data['row']->type =='firstuser')
                        <div class="form-check form-check-inline">

                    <input type="radio" id="first" name="type" value="0"  checked>
                    <label class="form-check-label ml-2" for="inlineRadio2">First User</label><br>
                    <input type="radio" id="first" name="type" value="1" class="form-check-input">
                        <label class="form-check-label ml-2" for="inlineRadio2">Second User</label><br>
                        <input type="radio" id="first" name="type" value="2">
                    <label class="form-check-label ml-2" for="inlineRadio2">Third User</label><br>
                    <input type="radio" id="first" name="type" value="3">
                    <label class="form-check-label ml-2" for="inlineRadio2">Admin User</label><br>
                        </div>

                    @elseif($data['row']->type =='seconduser')
                        <div class="form-check form-check-inline">
                    ...
                    @elseif($data['row']->type =='thirduser')
                        <div class="form-check form-check-inline">
                        ...
                        <input type="radio" id="first" name="type" value="1" class="form-check-input">
                        <label class="form-check-label ml-2" for="inlineRadio2">Second User</label><br>
                        <input type="radio" id="first" name="type" value="2" checked>
                        <label class="form-check-label ml-2" for="inlineRadio2">Third User</label><br>
                        <input type="radio" id="first" name="type" value="3">
                        <label class="form-check-label ml-2" for="inlineRadio2">Admin User</label><br>
                        </div>
                    ...
                    @else
                        ...
                        <input type="radio" id="first" name="type" value="2">
                        <label class="form-check-label ml-2" for="inlineRadio2">Third User</label><br>
                        <input type="radio" id="first" name="type" value="3" checked>
                        <label class="form-check-label ml-2" for="inlineRadio2">Admin User</label><br>
                        </div>
                    @endif
